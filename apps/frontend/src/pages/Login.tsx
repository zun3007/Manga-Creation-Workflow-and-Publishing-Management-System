...
function GoogleG() {
  return (
    <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden>
      <path
        fill="#EA4335"
        d="M24 9.5c3.5 0 6.6 1.2 9 3.6l6.7-6.7C35.6 2.6 30.1 0 24 0 14.6 0 6.5 5.4 2.6 13.3l7.8 6c1.9-5.6 7.1-9.8 13.6-9.8z"
      />
      <path
        fill="#4285F4"
      ...
      <path
        fill="#FBBC05"
        d="M10.4 28.7c-.5-1.4-.7-2.9-.7-4.7s.3-3.3.7-4.7l-7.8-6C.9 16.5 0 20.1 0 24s.9 7.5 2.6 10.7l7.8-6z"
      />
      <path
        fill="#34A853"
        d="M24 48c6.1 0 11.3-2 15-5.5l-7.4-5.7c-2 1.4-4.7 2.3-7.6 2.3-6.5 0-11.7-4.2-13.6-9.8l-7.8 6C6.5 42.6 14.6 48 24 48z"
      />
    </svg>
  );
}
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (isPasswordChangeRequired(res)) {
        setPasswordChallenge(res);
      } else if (isTwoFactorRequired(res)) {
        setChallenge(res);
      } else {
      ...
      <div className="grid min-h-screen lg:grid-cols-[1.1fr_0.9fr]">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              Nơi bản thảo thành chương truyện. Quản lý sáng tác, giao việc theo
              từng khung tranh, duyệt và xuất bản — tất cả trong một studio.
            </motion.p>
          </div>
          ...
          {passwordChallenge ? (
            ...
            >
              ...
              <p className="mt-2 text-sm text-ink-soft">
                Vào studio để tiếp tục sản xuất chương mới.
              </p>
              ...
              <form onSubmit={onSubmit} className="mt-6 space-y-5">
                ...
                <div>
                  ...
                  <div
                    className={`flex items-center gap-2 border rounded-[calc(var(--app-radius)*0.6)] bg-surface px-3 py-2 focus-within:border-accent transition ${passwordError ? "border-danger" : "border-line"}`}
              ...
              <a
                href={googleLoginUrl}
                className="inline-flex w-full items-center justify-center gap-2 rounded-[calc(var(--app-radius)*0.66)] border border-line bg-surface px-4 py-2 font-semibold transition hover:bg-bg text-ink"
              >
                <GoogleG />
                Tiếp tục với Google
              </a>
