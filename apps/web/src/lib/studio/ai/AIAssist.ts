...
export interface AIAssist {
  ...
  segment(composite: Uint8ClampedArray, w: number, h: number, point: Point, signal?: AbortSignal): Promise<Uint8Array>;
  /** Add a flat-color layer beneath line art by filling enclosed regions. */
  colorize(engine: StudioEngine, signal?: AbortSignal): Promise<void>;
}
