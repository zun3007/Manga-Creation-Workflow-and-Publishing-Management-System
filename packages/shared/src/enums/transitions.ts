...
export const PROPOSAL_TRANSITIONS: Record<ProposalStatus, ProposalStatus[]> = {
  ...
  [ProposalStatus.SUBMITTED]: [ProposalStatus.UNDER_REVIEW, ProposalStatus.APPROVED, ProposalStatus.REJECTED],
...
export const CHAPTER_TRANSITIONS: Record<ChapterStatus, ChapterStatus[]> = {
  ...
  [ChapterStatus.READY_FOR_EDITOR_REVIEW]: [ChapterStatus.EDITOR_APPROVED, ChapterStatus.IN_PROGRESS],
  [ChapterStatus.EDITOR_APPROVED]: [ChapterStatus.PUBLISHED],
...
export const TASK_TRANSITIONS: Record<TaskStatus, TaskStatus[]> = {
  ...
  [TaskStatus.REVISION_REQUIRED]: [TaskStatus.IN_PROGRESS, TaskStatus.SUBMITTED],
  [TaskStatus.APPROVED]: [],
};

export const SUBMISSION_TRANSITIONS: Record<SubmissionStatus, SubmissionStatus[]> = {
  [SubmissionStatus.PENDING]: [SubmissionStatus.UNDER_REVIEW, SubmissionStatus.APPROVED, SubmissionStatus.REVISION_REQUIRED, SubmissionStatus.REJECTED],
  [SubmissionStatus.UNDER_REVIEW]: [SubmissionStatus.APPROVED, SubmissionStatus.REVISION_REQUIRED, SubmissionStatus.REJECTED],
